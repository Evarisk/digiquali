...
class Activity extends SaturneObject
{
    ...
    public $fields = [
        ...
        'source'        => ['type' => 'html',         'label' => 'Source',           'enabled' => 1, 'position' => 15,  'notnull' => 0, 'visible' => 1, 'searchall' => 1, 'css' => 'minwidth200'],
        'source_from'   => ['type' => 'html',         'label' => 'SourceFrom',       'enabled' => 1, 'position' => 15,  'notnull' => 0, 'visible' => 1, 'searchall' => 1, 'css' => 'minwidth200'],
        'input_data'    => ['type' => 'html',         'label' => 'InputData',        'enabled' => 1, 'position' => 15,  'notnull' => 0, 'visible' => 1, 'searchall' => 1, 'css' => 'minwidth200'],
        'output_data'   => ['type' => 'html',         'label' => 'OutputData',       'enabled' => 1, 'position' => 15,  'notnull' => 0, 'visible' => 1, 'searchall' => 1, 'css' => 'minwidth200'],
        'score'         => ['type' => 'real',         'label' => 'ActualScore',      'enabled' => 1, 'position' => 35,  'notnull' => 0, 'visible' => 2, 'help' => 'PercentageValue'],
        'target_score'  => ['type' => 'real',         'label' => 'TargetScore',      'enabled' => 1, 'position' => 35,  'notnull' => 0, 'visible' => 2, 'help' => 'PercentageValue'],
