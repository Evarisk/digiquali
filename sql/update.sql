...
-- 23.2.0
ALTER TABLE llx_digiquali_question ADD version integer DEFAULT 0 NOT NULL AFTER status;
UPDATE llx_digiquali_question SET version = 0 WHERE version IS NULL;
ALTER TABLE llx_digiquali_question DROP INDEX uk_digiquali_question_ref;
ALTER TABLE llx_digiquali_question DROP INDEX uk_dolismq_question_ref;
